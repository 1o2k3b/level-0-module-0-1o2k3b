...
// This line of code creates  variable to hold your faccate picture
...
cat = loadImage("lasercat.jpg");
  
// 3. Set the size of the sketch. Make it big enough to show the cat you chosec
size(700, 700);
